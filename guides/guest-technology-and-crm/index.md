---
title: Hotel Guest Technology, CRM and Loyalty: A Full Guide
url: https://richard-bedenham.github.io/guides/guest-technology-and-crm/
markdown_url: https://richard-bedenham.github.io/guides/guest-technology-and-crm/index.md
...
![A bright hotel lobby where a guest walks past reception with a phone, while floating icons for profiles, messages, stars and keys hover near the desk and wall screens.](c06-00-guest-technology-crm-cover.jpg)
...
![A guest with a suitcase walks past a back office where five colleagues each look at a different screen showing a different coloured version of the same record.](c06-01-one-guest-five-records.jpg)
...
![A guest reads her phone in a doorway while a member of staff hands over towels, with an orange speech bubble beside her and email and chat icons beside him.](c06-02-service-vs-marketing.jpg)
...
![Two colleagues study a screen together, one pointing, while icons for email, phone, loyalty, payment and wi-fi are joined by dotted lines to a single glowing marker.](c06-03-guest-identity-resolution.jpg)

*No system in your hotel holds a shared number for a person. Every link between them has to be built and maintained.*

It is tempting to say your systems do not hold people at all, only transactions. That was true once. It is not true now. Every serious property management system holds a proper record of a person. Suppliers call it a profile, a customer, a central store of guest data or a single guest profile. Some go further and separate the person who booked from the main guest. Nor are those records sealed off. Some point of sale systems, the tills behind your bar and restaurant, can pull the guest profile onto a restaurant bill, preferences included. Spa systems sync with the major PMS brands.
...
You will be told to insist that merges can be undone, so a bad one can be reversed. The advice is right in spirit. In at least one of the most widely used hotel PMS platforms, it is simply not available. The supplier's own documentation says it plainly. Once a merge finishes, the second profile no longer exists and you cannot undo it. Several well-known guest data platforms say the same. Other systems do work the other way and keep the absorbed record linked rather than deleted. Some rebuild profiles from the original events, so undo means change the rules and run it again.
...
![A manager in an office holds up two floating cards, one of stars and one of a clock, while two colleagues pin notes to a planning board nearby.](c06-04-reviews-score-ranking.jpg)
...
![A guest holds a phone to a guest room lock in a corridor, with a cutaway showing riser cabling, lift shafts and a colleague issuing the key on a tablet.](c06-05-mobile-key-ecosystem.jpg)
...
![A guest with a backpack stands at reception while a manager holds a tablet of ticked boxes, linked by a line to a grid of rooms on the desk.](c06-06-upsell-meets-operations.jpg)
...
![A receptionist smiles as she hands a returning guest a newspaper and a cup of coffee, with an abstract tier diagram on a screen behind them.](c06-07-recognition-over-points.jpg)
