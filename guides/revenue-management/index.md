---
title: Hotel Revenue Management: A Complete Practical Guide
url: https://rbedenham.github.io/guides/revenue-management/
markdown_url: https://rbedenham.github.io/guides/revenue-management/index.md
...
![A revenue manager stands on a sunlit hotel terrace holding a tablet showing a coloured pricing calendar, with rising line graphs, a city skyline and colleagues behind glass.](c04-00-hotel-revenue-management-cover.jpg)
...
![A hotel manager and a colleague at a desk trace a glowing line from a price tag icon back to a calendar, a demand graph and a cancelled block of rooms.](c04-01-the-rate-and-the-reason.jpg)
...
![A woman with a tablet looks from a terrace across a Mediterranean harbour town at two contrasting hotel buildings, with small icons for guests, money and services floating between them.](c04-02-beyond-revpar.jpg)
...
![Two colleagues study a curved glass wall in a hotel lobby covered with several coloured booking curves, some solid and some dashed, while guests arrive with luggage behind them.](c04-03-pickup-pace-booking-curves.jpg)
...
![Two colleagues at a table discuss a large screen showing a price marker on a vertical scale between a floor and a ceiling, beside a comment note and a review date.](c04-04-pricing-governance.jpg)
...
![Different guests cross a hotel lobby, a business traveller, two backpackers and a woman at reception, beside a screen where coloured lines fan out from a calendar.](c04-05-segment-channel-mix.jpg)
...
![A revenue manager holding a tablet watches a wall screen showing a demand curve with an exception flagged, a ceiling bar above it and a floor line below.](c04-06-human-plus-automation.jpg)
...
- **[Sales, Groups and MICE](../sales-groups-and-mice/)** owns blocks, options and the rooms groups hand back. Displacement analysis is the shared border, and neither side should quote group business alone.
- **[Data, APIs and Integration](../data-apis-and-integration/)** moves forecasts, rates, restrictions and decisions between systems. Most automation ambitions eventually meet this layer.
- **[AI, Automation and Agents](../ai-automation-and-agents/)** covers model-driven pricing and the capture of decision reasoning. Technically it may live elsewhere, but commercially the consequences belong here.
- **[Hotel Technology Strategy](../hotel-technology-strategy/)** covers whether to buy an RMS and how to judge one, while **[Emerging Hotel Technology](../emerging-hotel-technology/)** tracks pricing approaches that are not yet stable enough to plan around.
